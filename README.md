...
- **Registry id:** `tpl_ecommerce_luxury`
- **Showcased on:** https://seojack.net/templates/tpl_ecommerce_luxury
...
| `app/styles.ts` | one scoped CSS literal (every selector prefixed `.ecommerce-luxury-demo`) |
...
Own GitHub repo (`seojack-templates/template-ecommerce-luxury`) + own Vercel project,
production domain `https://ecommerce-luxury.templates.seojack.website`. See `docs/templates-github-org.md`.